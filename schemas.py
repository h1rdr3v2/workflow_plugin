...
WORKFLOW_WAIT_FOR_USER = {
    ...
    "description": (
        ...
        "a human can make.\n\n"
        "The question is delivered to the workflow's chat automatically. The "
        "human answers with the /workflows respond <action_id> <answer> "
        "command, and their freeform text resumes the workflow.\n\n"
